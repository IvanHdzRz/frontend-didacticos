...
export const Didactico = ({number,title,type,stock,stockLevel}) => {
    
    return (
        <div className="animate-showUp bg-white mb-1 grid grid-cols-12 place-items-center py-4  px-2 gap-x-2 hover:">
